          ...
          {activeTab === 'general' && (
            <div className="settings-section">
              ...
              <div className="about-info">
                <p><strong>HotPage {appVersion.trim()}</strong></p>
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    const cityPhotos = [
                      ...
                      'https://images.pexels.com/photos/3586966/pexels-photo-3586966.jpeg?auto=compress&cs=tinysrgb&w=2400',
                ...
                <>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 'var(--spacing-sm)', marginBottom: 'var(--spacing-md)' }}>
                    ...
                    <button
                      ...
                      style={{ flex: '1 1 calc(50% - var(--spacing-sm) / 2)', padding: 'var(--spacing-md)', fontSize: '13px', minWidth: '120px' }}
