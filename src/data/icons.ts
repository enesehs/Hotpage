export const currencyIcons: Record<string, string> = {
  USD: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16.7 8a3 3 0 0 0-2.7-2h-4a3 3 0 0 0 0 6h4a3 3 0 0 1 0 6h-4a3 3 0 0 1-2.7-2"/><path d="M12 3v3m0 12v3"/></svg>',
  ...
  GBP: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="m5.553 19.105l.764 1.843C7.498 20.555 9.422 20 10 20c.838 0 1.462.208 2.184.448c.775.259 1.654.552 2.816.552c1.177 0 3.078-.921 3.447-1.105l-.895-1.789c-.721.36-2.031.894-2.552.894c-.838 0-1.462-.208-2.184-.448C12.041 18.293 11.162 18 10 18c-.229 0-.526.037-.857.099C9.702 16.95 10 15.561 10 14h3v-2H9.626c-.042-.107-.084-.216-.125-.317C9.243 11.052 9 10.455 9 9c0-1.369.521-3 3-3c2.224 0 3.021 2.227 3.052 2.316l1.896-.633C16.898 7.533 15.679 4 12 4C8.313 4 7 6.583 7 9c0 1.491.234 2.35.478 3H5v2h3c0 2.467-.892 4.328-2.447 5.105"/></svg>',
  JPY: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 19v-7m0 0L6 5m6 7 6-7m-9 8h6m-6 4h6"/></svg>',
  TRY: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 5v14"/><path d="M6 9l8-2"/><path d="M6 13l8-2"/><path d="M14 9c2 0 4 2 4 5s-2 5-4 5"/></svg>',
  XAU: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="m1 22l1.5-5h7l1.5 5zm12 0l1.5-5h7l1.5 5zm-7-7l1.5-5h7l1.5 5zm17-8.95l-3.86 1.09L18.05 11l-1.09-3.86l-3.86-1.09l3.86-1.09l1.09-3.86l1.09 3.86z"/></svg>',
};

export const cryptoIcons: Record<string, string> = {
  bitcoin: '<svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 56 56"><path fill="currentColor" fill-rule="evenodd" d="M28 44.411h-4V49.4h-5v-4.989h-1.305V44.4H13v-5h4.695V17H13v-5h6V7h5v5h4V7h5v5h-1.2c6.088 0 9.906 3.122 9.906 8.086c0 3.549-2.65 6.514-6.087 7.03v.18c4.402.337 7.637 3.549 7.637 7.839c0 5.52-4.017 9.043-10.546 9.265H33v5h-5zm-3.521-27.357v8.423h4.874c3.616 0 5.682-1.595 5.682-4.335c0-2.606-1.82-4.088-4.986-4.088zm0 22.303h5.84c3.908 0 6.019-1.662 6.019-4.761c0-3.033-2.179-4.65-6.177-4.65H24.48z"/></svg>',
  ethereum: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L4 12l8 4 8-4-8-10z"/><path d="M4 12l8 10 8-10"/><path d="M12 16l-8-4 8-4 8 4-8 4z"/></svg>',
  binancecoin: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2l3 3-3 3-3-3 3-3z"/><path d="M19 9l3 3-3 3-3-3 3-3z"/><path d="M5 9l3 3-3 3-3-3 3-3z"/><path d="M12 16l3 3-3 3-3-3 3-3z"/><path d="M12 9l3 3-3 3-3-3 3-3z"/></svg>',
  solana: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path fill="currentColor" fill-rule="evenodd" d="M2.45 6.76h9.59c.12 0 .23.05.32.14l1.52 1.56c.28.29.08.78-.32.78H3.97c-.12 0-.23-.05-.32-.14L2.13 7.54c-.28-.29-.08-.78.32-.78m-.32-2.07l1.52-1.56c.08-.09.2-.14.32-.14h9.58c.4 0 .6.49.32.78l-1.51 1.56c-.08.09-.2.14-.32.14H2.45c-.4 0-.6-.49-.32-.78m11.74 6.61l-1.52 1.56c-.09.09-.2.14-.32.14H2.45c-.4 0-.6-.49-.32-.78l1.52-1.56c.08-.09.2-.14.32-.14h9.58c.4 0 .6.49.32.78"/></svg>',
  ripple: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><circle cx="6" cy="6" r="2"/><circle cx="18" cy="6" r="2"/><circle cx="6" cy="18" r="2"/><circle cx="18" cy="18" r="2"/><path d="M9.5 9.5L7.5 7.5m7 0l2 2m-7 7l-2 2m9-2l-2-2"/></svg>',
  cardano: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="2"/><circle cx="12" cy="5" r="1.5"/><circle cx="12" cy="19" r="1.5"/><circle cx="5" cy="8.5" r="1.5"/><circle cx="19" cy="8.5" r="1.5"/><circle cx="5" cy="15.5" r="1.5"/><circle cx="19" cy="15.5" r="1.5"/></svg>',
  dogecoin: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 6h3a6 6 0 0 1 0 12H9V6z"/><path d="M6 12h6"/></svg>',
  avalanche: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 4L3 20h6l3-6 3 6h6L12 4z"/></svg>',
  'avalanche-2': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 4L3 20h6l3-6 3 6h6L12 4z"/></svg>',
  polkadot: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="6" r="3"/><circle cx="12" cy="18" r="3"/><circle cx="12" cy="12" r="2"/><path d="M12 9v1m0 4v1"/></svg>',
};

export const uiIcons = {
  settings: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M12 1v6m0 6v6m5.656-14.656l-4.242 4.242m-2.828 2.828l-4.242 4.242m14.656 0l-4.242-4.242m-2.828-2.828L1.344 6.344"/></svg>',
  ...
  palette: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 2a10 10 0 0 1 0 20c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2 .9 2 2 2a10 10 0 0 0 0-20z"/><circle cx="7.5" cy="10.5" r="1.5"/><circle cx="16.5" cy="10.5" r="1.5"/><circle cx="12" cy="16.5" r="1.5"/></svg>',
  ...
  stickyNote: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15.5 3H5a2 2 0 0 0-2 2v14c0 1.1.9 2 2 2h14a2 2 0 0 0 2-2V8.5L15.5 3Z"/><path d="M15 3v6h6"/></svg>',
  ...
  refresh: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.5 2v6h-6M2.5 22v-6h6M2 11.5a10 10 0 0 1 18.8-4.3M22 12.5a10 10 0 0 1-18.8 4.2"/></svg>',
...
export const iconLibrary: IconOption[] = [
  ...
  },
  {
    name: 'Twitter/X',
    category: 'Social',
    svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4l11.733 16h4.267l-11.733 -16z"></path><path d="M4 20l6.768 -6.768m2.46 -2.46l6.772 -6.772"></path></svg>'
  },
  {
    name: 'LinkedIn',
    category: 'Social',
  ...
  },
  {
    name: 'Reddit',
    category: 'Social',
    svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><circle cx="9.5" cy="10" r="0.5" fill="currentColor"></circle><circle cx="14.5" cy="10" r="0.5" fill="currentColor"></circle><path d="M8 14.5s1.5 2 4 2 4-2 4-2"></path></svg>'
  },
  {
    name: 'Discord',
    category: 'Social',
    svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.5 11c0 .83-.67 1.5-1.5 1.5S6.5 11.83 6.5 11s.67-1.5 1.5-1.5 1.5.67 1.5 1.5zm6.5 0c0 .83-.67 1.5-1.5 1.5s-1.5-.67-1.5-1.5.67-1.5 1.5-1.5 1.5.67 1.5 1.5z"></path><path d="M18.5 4.5a14.5 14.5 0 0 0-3.5-1.1.054.054 0 0 0-.057.027c-.15.27-.32.62-.44.9a13.5 13.5 0 0 0-4 0c-.12-.28-.29-.63-.44-.9a.056.056 0 0 0-.057-.027 14.5 14.5 0 0 0-3.5 1.1.05.05 0 0 0-.024.02C.83 8.67-.5 12.7.15 16.67a.06.06 0 0 0 .023.042 14.6 14.6 0 0 0 4.4 2.23.056.056 0 0 0 .061-.02c.34-.46.64-.95.9-1.47a.055.055 0 0 0-.03-.076 9.6 9.6 0 0 1-1.37-.66.056.056 0 0 1-.005-.093c.09-.07.18-.14.27-.21a.054.054 0 0 1 .056-.008c2.88 1.31 6 1.31 8.84 0a.054.054 0 0 1 .057.007c.09.07.18.14.27.21a.056.056 0 0 1-.004.094c-.44.26-.9.48-1.37.66a.056.056 0 0 0-.03.076c.26.52.57 1.01.9 1.47a.056.056 0 0 0 .061.02 14.5 14.5 0 0 0 4.41-2.23.056.056 0 0 0 .023-.041c.77-4.58-.77-8.56-3.25-12.09a.044.044 0 0 0-.023-.02z"></path></svg>'
  },
  {
    name: 'Slack',
    category: 'Social',
  ...
  },
  {
    name: 'Twitch',
    category: 'Social',
    svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 2H3v16h5v4l4-4h5l4-4V2zm-10 9V7m5 4V7"></path></svg>'
  },
  {
    name: 'TikTok',
    category: 'Social',
    svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 12a4 4 0 1 0 4 4V4a5 5 0 0 0 5 5"></path></svg>'
  },
  {
    name: 'WhatsApp',
    category: 'Social',
  ...
  },
  {
    name: 'Snapchat',
    category: 'Social',
    svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3c-4.4 0-6 3.6-6 6.7 0 1.8.3 2.9-.8 3.5-.7.4-1.7.3-2.2.9-.3.4-.2 1 .3 1.3 1.4.9 3.1 1 4 2.4.5.7.3 1.6.3 2.4 0 .6.4.8.9.8 1 0 1.7-.8 3.5-.8s2.5.8 3.5.8c.5 0 .9-.2.9-.8 0-.8-.2-1.7.3-2.4.9-1.4 2.6-1.5 4-2.4.5-.3.6-.9.3-1.3-.5-.6-1.5-.5-2.2-.9-1.1-.6-.8-1.7-.8-3.5C18 6.6 16.4 3 12 3z"></path></svg>'
  },
  {
    name: 'Pinterest',
    category: 'Social',
    svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="2" x2="12" y2="22"></line><path d="M12 2a7 7 0 0 0-7 7c0 2.38 1.19 4.47 3 5.74"></path><path d="M17 9a5 5 0 1 0-5 5"></path></svg>'
  },
  {
    name: 'Medium',
    category: 'Social',
    svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="7" cy="12" r="5"></circle><ellipse cx="17.5" cy="12" rx="2.5" ry="5"></ellipse><line x1="22" y1="7" x2="22" y2="17"></line></svg>'
  },
  {
    name: 'Spotify',
    category: 'Social',
    svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M8 15c2-1 5-1 8 0"></path><path d="M7.5 12c2.5-1.5 6-1.5 9 0"></path><path d="M7 9c3-1.5 7-1.5 10 0"></path></svg>'
  },
  {
    name: 'Dribbble',
    category: 'Social',
    svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M8.56 2.75c4.37 6.03 6.02 9.42 8.03 17.51m2.54-15.38c-3.72 4.35-8.94 5.66-16.88 5.85m19.5 1.9c-3.5-.93-6.63-.82-8.94 0-2.58.92-5.01 2.86-7.44 6.32"></path></svg>'
  },
  {
    name: 'Behance',
    category: 'Social',
  ...
  },
  {
    name: 'Bookmark',
    category: 'Productivity',
    svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path></svg>'
  },
  {
    name: 'Clipboard',
    category: 'Productivity',
    svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"></path><rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect></svg>'
  },
  {
    name: 'Check',
    category: 'Productivity',
  ...
  },
  {
    name: 'Trello',
    category: 'Productivity',
    svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><rect x="7" y="7" width="3" height="9"></rect><rect x="14" y="7" width="3" height="5"></rect></svg>'
  },
  {
    name: 'Notion',
    category: 'Productivity',
  ...
  },
  {
    name: 'Netflix',
    category: 'Media',
    svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M5 2v20l6.5-7.5L5 2zm8 0v20l6.5-7.5L13 2z"></path></svg>'
  },
  {
    name: 'Play',
    category: 'Media',
  ...
  },
  {
    name: 'Search',
    category: 'Other',
    svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><path d="m21 21-4.3-4.3"></path></svg>'
  },
  {
    name: 'Settings',
    category: 'Other',
  ...
  },
  {
    name: 'Cloud',
    category: 'Other',
    svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z"></path></svg>'
  },
  {
    name: 'Download',
    category: 'Other',
    svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" x2="12" y1="15" y2="3"></line></svg>'
  },
  {
    name: 'Amazon',
    category: 'Other',
    svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 18c4-2 8-2 12 0M4 21c5-2 10-2 16 0M12 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"></path></svg>'
  },
  {
    name: 'Google',
    category: 'Other',
    svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12.48 10.92v3.28h7.84c-.24 1.84-.853 3.187-1.787 4.133-1.147 1.147-2.933 2.4-6.053 2.4-4.827 0-8.6-3.893-8.6-8.72s3.773-8.72 8.6-8.72c2.6 0 4.507 1.027 5.907 2.347l2.307-2.307C18.747 1.44 16.133 0 12.48 0 5.867 0 .307 5.387.307 12s5.56 12 12.173 12c3.573 0 6.267-1.173 8.373-3.36 2.16-2.16 2.84-5.213 2.84-7.667 0-.76-.053-1.467-.173-2.053H12.48z"></path></svg>'
  },
];
